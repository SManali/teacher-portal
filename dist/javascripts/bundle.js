...
var _studentList = __webpack_require__(27);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.performLogin = _this.performLogin.bind(_this);
    _this.performSignIn = _this.performSignIn.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'performLogin',
    value: function performLogin(userId, password) {
      var args = {
        data: {
          userId: userId,
          password: password
      ...
      var self = this;
      _superagent2.default.post('/login/authenticateUser', args).end(function (err, data) {
        console.log(data);
        if (!err) {
          self.setState({
    ...
    key: 'performSignIn',
    value: function performSignIn(userId, password) {
      var _this2 = this;
      ...
      _superagent2.default.post('/login/createUser', args).end(function (err, data) {
        console.log(data);
        if (!err) {
          _this2.setState({
            redirectUrl: "/students"
    ...
    value: function render() {
      ...
      var redirect = function redirect() {
        if (_this3.state.redirectUrl) {
          return _react2.default.createElement(_reactRouterDom.Redirect, { to: _this3.state.redirectUrl });
        } else {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_reactRouterDom.Route, { path: '/sign-up', exact: true, component: function component() {
                return _react2.default.createElement(_signUp2.default, { isAuthed: true, localizedText: {
                    "userIDLabel": "Email ID / Phone Number",
                    "newAccountHeaderText": "Create a new Account",
                    "passwordLabel": "Password",
                    "submitButtonText": "Submit"
                  },
                  performSignIn: _this3.performSignIn });
              } }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/login', exact: true, component: function component() {
                return _react2.default.createElement(_login2.default, { isAuthed: true, localizedText: {
                    "userIDLabel": "Email ID / Phone Number",
            ...
            _react2.default.createElement(_reactRouterDom.Route, { path: '/students', exact: true, component: function component() {
                return _react2.default.createElement(_studentList2.default, null);
              } }),
            redirect()
          )
        )
...
const RequestBase = __webpack_require__(14);
const isObject = __webpack_require__(6);
const ResponseBase = __webpack_require__(15);
const Agent = __webpack_require__(17);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // export default Login;
...
var Login = function (_React$Component) {
    ...
    _createClass(Login, [{
        ...
        value: function loginUser() {
            ...
            var errorText = this.getErrorText(userId, password);
            this.setState({
                "errorText": errorText
            });
            if (errorText === "") {
        ...
        key: 'getErrorText',
        value: function getErrorText(userId, password) {
            var errorText = "";
            if (userId === "" || password === "") {
        ...
        value: function render() {
            ...
            var text = this.props.localizedText;
            var getError = function getError() {
                if (_this2.state.errorText) {
                    return _react2.default.createElement(
                        'div',
                        null,
            ...
            return _react2.default.createElement(
                'div',
                { 'class': 'dashboard-main-holder vertical-horizontal-center' },
                getError(),
                _react2.default.createElement(
                    'div',
                    { 'class': 'envelope-holder' },
                    _react2.default.createElement('img', { src: 'assets/images/envelope.jpg' })
                ),
                _react2.default.createElement(
                    'div',
                    { 'class': 'account-board' },
                    _react2.default.createElement(
                        'div',
                        { 'class': 'account-header text-center common-header-footer-margin' },
                        text.loginAccountHeaderText
                    ),
                    _react2.default.createElement(
                        'div',
                        { 'class': 'account-form' },
                        _react2.default.createElement(
                            'div',
                            { 'class': 'userid-details form-group' },
                            _react2.default.createElement(
                                'label',
                                { 'for': 'userid', 'class': 'userid-label' },
                                text.userIDLabel
                            ),
                            _react2.default.createElement('input', { type: 'text', 'class': 'userid-field form-control', id: 'userid', ref: function ref(child) {
                                    _this2.userId = child;
                                } })
                        ),
                        _react2.default.createElement(
                            'div',
                            { 'class': 'password-details form-group' },
                            _react2.default.createElement(
                                'label',
                                { 'for': 'userPassword', 'class': 'password-label' },
                                text.passwordLabel
                            ),
                            _react2.default.createElement('input', { type: 'text', 'class': 'password-field form-control', id: 'userPassword', ref: function ref(child) {
                                    _this2.password = child;
                                } })
                        ),
                        _react2.default.createElement(
                            'div',
                            { 'class': 'submit-button-container text-center' },
                            _react2.default.createElement('input', { type: 'button', 'class': 'btn', value: text.submitButtonText, onClick: this.loginUser })
                        )
                    ),
                    _react2.default.createElement(
...
var SignIn = function (_React$Component) {
    ...
    function SignIn(props) {
        ...
        _this.signInUser = _this.signInUser.bind(_this);
        return _this;
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { 'class': 'submit-button-container text-center' },
                            _react2.default.createElement('input', { type: 'button', 'class': 'btn', value: text.submitButtonText, onClick: this.signInUser })
                        )
                    )
                )
            );
...
var StudentsList = function (_React$Component) {
    ...
    function StudentsList(props) {
        ...
        return _possibleConstructorReturn(this, (StudentsList.__proto__ || Object.getPrototypeOf(StudentsList)).call(this, props));
    }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { "class": "lead-logo-container text-center container d-inline-block" },
                        "LEAD Logo"
                    ),
                    _react2.default.createElement(
                        "div",
                        { "class": "profile-info-container d-inline-block" },
                        _react2.default.createElement("span", { "class": "notification fas fa-bell" }),
                        _react2.default.createElement(
                            "div",
                            { "class": "profile-name-info d-inline-block" },
                            _react2.default.createElement("span", { "class": "fas fa-user" }),
                            " Person Name"
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { "class": "students-control-container d-inline-block" },
                        _react2.default.createElement(
                            "div",
                            { "class": "list-group" },
                            _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { "class": "list-group-item list-group-item-action view-students" },
                                "- View Students"
                            ),
                            _react2.default.createElement(
                                "div",
                                { "class": "list-group-item list-group-item-action add-student" },
                                "- Add Student"
                            )
                        )
                    ),
                    _react2.default.createElement("div", { "class": "students-view-container" })
                )
            );
        }
    }]);
